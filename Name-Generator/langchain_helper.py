...
def generate_baby_names(gender: str,nationality:str) -> list[str]:
    ...
    prompt_template_name = PromptTemplate(
        ...
        template="""I want to find a name for a {nationality} {gender} baby. Suggest top 5 popular names for the baby in last 10 years.
...
if __name__ == "__main__":
    print(generate_baby_names("Chinese"))